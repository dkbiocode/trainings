...
<a href="../fig/kraken-taxonomic-tree.png">
  <img src="../fig/kraken-taxonomic-tree.png" alt="Diagram of a taxonomic tree with four levels of nodes, some nodes have a number from 1 to 3, and some do not. From the most recent nodes, one has a three, and its parent nodes do not have numbers. This node with a three is selected." />
</a>
...
<a href="../fig/sequencing-bias-composition.png">
  <img src="../fig/sequencing-bias-composition.png" alt="Flow diagram that shows how the initial composition of 33% for each of the three taxa in the sample ends up being 4%, 72%, and 24% after the biases imposed by the extraction, PCR, sequencing and bioinformatics steps." />
</a>
...
<a href="../fig/krona-taxonomy-abundance.png">
  <img src="../fig/krona-taxonomy-abundance.png" alt="Krona displays a circled-shape bacterial taxonomy plot with abundance percentages of each taxon" />
</a>
...
<a href="../fig/pavian-upload-reports.png">
  <img src="../fig/pavian-upload-reports.png" alt="Pavian website showing the upload of two reports" />
</a>

We click on the Results Overview tab.

<a href="../fig/pavian-results-overview.png">
  <img src="../fig/pavian-results-overview.png" alt="Results Overview tab of the Pavian website where it shows the number of reads classified to several categories for the two samples" />
</a>

We click on the Sample tab.

<a href="../fig/pavian-sankey-taxonomy.png">
  <img src="../fig/pavian-sankey-taxonomy.png" alt="Sankey type visualization that shows the abundance of each taxonomic label in a tree-like manner" />
</a>

We can look at the abundance of a specific taxon by clicking on it.

<a href="../fig/pavian-abundance-bar-chart.png">
  <img src="../fig/pavian-abundance-bar-chart.png" alt="A bar chart of the abundance of reads of the two samples, showing a segment for the read identified at the specific taxon and another segment for the number of reads identifies at children of the specified taxon" />
</a>

We can look at a comparison of both our samples in the Comparison tab. 

<a href="../fig/pavian-kraken-combined-table.png">
  <img src="../fig/pavian-kraken-combined-table.png" alt="A table of the same format as the Kraken report but for both samples at once." />
</a>
...
[Previous: Metagenome Binning](05-binning.md) | [Next: Exploring Taxonomy with R](07-phyloseq.md)
