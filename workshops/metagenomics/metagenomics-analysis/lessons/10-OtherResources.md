...
by Schmeier explains each step of the process carefully. There is a beautiful entry called [History of metagenomics](http://merenlab.org/2020/07/27/history-of-metagenomics/) in the Meren Lab blog 
...
<a href="../fig/phylum-relative-abundance-pie.png">
  <img src="../fig/phylum-relative-abundance-pie.png" alt="Pie chart showing the relative abundance at the phylum level, and the legend with the phylum names, read count, and percentages." />
</a>
...
<a href="../fig/functional-categories-pie.png">
  <img src="../fig/functional-categories-pie.png" alt="Pie chart showing the relative abundance of general functional categories, and the legend with the category names, read count, and percentages." />
</a>

<a href="../fig/specific-functional-categories-pie.png">
  <img src="../fig/specific-functional-categories-pie.png" alt="Pie chart showing the relative abundance of specific functional categories, and the legend with the category names, read count, and percentages." />
</a>
...
[Previous: Taxonomic Analysis with R](09-abundance-analyses.md)
