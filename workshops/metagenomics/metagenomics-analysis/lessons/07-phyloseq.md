...
<a href="../fig/phyloseq-tax-table.png">
  <img src="../fig/phyloseq-tax-table.png" alt="A table where the taxonomic 
...
<a href="../fig/phyloseq-tax-table-named.png">
  <img src="../fig/phyloseq-tax-table-named.png" alt="The same table we saw in Figure 3 but with informative names in each of the columns. Now, we can see which of 
...
<a href="../fig/phyloseq-otu-abundance-table.png">
  <img src="../fig/phyloseq-otu-abundance-table.png" alt="A table where the abundance of each OTU in each sample is shown. Each row represents one 
...
[Previous: Taxonomic Assignment](06-taxonomic.md) | [Next: Diversity Tackled With R](08-Diversity-tackled-with-R.md)
