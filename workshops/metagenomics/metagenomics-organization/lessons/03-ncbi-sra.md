...
<img style='border:1px solid #000000' src="../../fig/data-organization-fig/01-03-01.png" width="800" alt="Screenshot of the cover page of the article named: Genomic adaptations in information processing underpin trophic strategy in a whole-ecosystem nutrient enrichment experiment"/>
...
<img style='border:1px solid #000000' src="../../fig/data-organization-fig/01-03-04.png" width="800" alt="Screenshot of the sections Select and Found 40 Items"/>
...
<img style='border:1px solid #000000' src="../../fig/data-organization-fig/01-03-05.png" width="800" alt="Screenshot of details for the selected run. It shows the details of the sequence file, a quality graph, the metadata, the Biosample details, and BioProject details."/>
...
<img style='border:1px solid #000000' src="../../fig/data-organization-fig/01-03-06.png" width="800" alt="Screenshot of the section Select, with two rows with the number of runs, bytes, bases, and buttons to download the Metadata and Accession List, one row for Total and one row for Selected."/>
...
[Previous lesson: Planning for NGS Projects (02-project-planning.md)](02-project-planning.md)
