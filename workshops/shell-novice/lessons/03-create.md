...
Let's first move back to the `writing` directory, then move `quotes.txt` from `thesis/` into our current working directory.
...
~~~
/workspaces/trainings/workshops/shell-novice/shell-lesson-data/exercise-data/writing $ ls thesis/quotes.txt
~~~
